...
// Add type for the WebGL context
...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Rename this function to handleResize
    const handleResize = () => {
    ...
    // Update pointerPrototype to use proper typing
    ...
    let pointers: Pointer[] = [new PointerPrototype()];
    ...
    function compileShader(type: number, source: string, keywords?: string[]) {
      ...
      return createShader(gl, type, processedSource);
    }

    // Update Material class with proper typing
    class Material {
    ...
    // Update Program class with proper typing
    class Program {
      uniforms: { [key: string]: WebGLUniformLocation | null };
    ...
    // Keep this function name as resizeCanvas
    ...
    return () => {
      ...
      // Add any necessary WebGL cleanup here
      if (gl) {
